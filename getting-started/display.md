...
The [Display](https://docs.rendleysdk.com/api-reference/classes/Display.html) represents the WebGL canvas where the SDK renders its changes. Here, you can set the video's resolution and background color, and access methods to retrieve sprite elements positioned at specific coordinates.
