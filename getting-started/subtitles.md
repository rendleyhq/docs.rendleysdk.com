...
To add subtitles manually, you need to define a [Subtitles](https://docs.rendleysdk.com/api-reference/classes/Subtitles.html) object that contains a list of text blocks. Each text block specifies the text content, the start time, and the duration, all measured in seconds.
