...
To export the final video, simply call the [`export()`](https://docs.rendleysdk.com/api-reference/classes/Engine.html#export) function, which will return a Blob URL for the final video.
