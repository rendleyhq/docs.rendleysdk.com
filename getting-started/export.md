...
To export the final video, simply call the [`export()`](https://rendley.com/docs/api-reference/classes/Engine.html#export) function, which will return a Blob URL for the final video.
